import { Transport, BaseTransport } from '@magicbutton.cloud/messaging';
...
export class NatsTransport extends BaseTransport implements Transport {
  ...
  private async processSubscription(
    ...
    handler: (subject: string, headers: headers | undefined, data: any) => void
  ): Promise<void> {
